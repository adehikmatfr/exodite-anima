...
| THR-004 | B1, B3 | I | Content shown in the app-switcher preview, screenshots, or screen recording | 3 | 2 | 6 | Obscure the preview when backgrounded; Android screenshots and recording blocked by the secure-window flag in release builds (decided and built; iOS not built) | Manual check on both platforms | product-design, frontend-mobile | open |
