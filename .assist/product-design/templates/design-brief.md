...
|-----------|--------|----------|--------|--------------|-------|
| <outcome> | <e.g. task completion rate> | <value or unknown> | <value by date> | <usability test / analytics event> | product-design |
...
|----|------|-----------|--------|------------|-------|
| RISK-NNN | <risk> | <L/M/H> | <L/M/H> | <action> | product-design |
