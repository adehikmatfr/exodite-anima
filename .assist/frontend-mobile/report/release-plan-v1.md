...
|------|---------------|--------|
| Version | `1.1.0+2` in `app/pubspec.yaml` (v1.0.0+1 was v1.0.0-beta.1's pre-release, 2026-09-20; bumped to 1.1.0+2 for v1.1.0-beta.1, 2026-09-23, bundling FEAT-010 and FEAT-011) | Marketing version plus a build number that only increases (Android versionCode, iOS build number) |
