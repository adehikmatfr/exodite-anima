# .assist / frontend-mobile

This folder holds the **context**, **prompts**, **skills**, and **documentation** that let an AI assistant work as `frontend-mobile` on `exodite-anima` without re-scanning the whole codebase.
