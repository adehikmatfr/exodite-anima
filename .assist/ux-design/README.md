...
This folder holds the **context**, **prompts**, **skills**, and **documentation** that let an AI assistant work as `ux-design` on `exodite-anima` without re-scanning the whole codebase.
