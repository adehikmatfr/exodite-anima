...
| TP-001 | Version 1 release test plan | draft | qa | `qa/test-plans/TP-001-v1-release.md` | FEAT-001..009, RISK-001..010, THR-001..015 |
...
| RISK-001..010 | Product and technical risk register | active | product-manager | `product-manager/report/risk-register.md` | ADR-001, ADR-002, ADR-003, FEAT-001..009 |
